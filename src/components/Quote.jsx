...
const inp = 'w-full bg-white/[0.04] border border-white/[0.06] rounded px-3 py-2.5 text-white text-[14px] placeholder-white/30 focus:outline-none focus:border-[#C9A800]/40 transition-colors';
const lbl = 'text-white/60 text-[12px] font-semibold uppercase tracking-[0.1em] block mb-1';
    ...
    <section id="quote" className="py-14 lg:py-20 bg-[#0f0f0f] border-t border-white/[0.04]">
      <div className="max-w-[1100px] mx-auto px-5">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-16 items-start">
          ...
          >
            <p className="text-[#C9A800] text-[13px] font-semibold tracking-[0.25em] uppercase mb-3">Get a Quote</p>
            ...
            <div className="flex flex-col gap-2 text-[14px]">
              <a href="tel:+919380000001" className="text-white/65 hover:text-[#C9A800] flex items-center gap-1.5 transition-colors"><Phone size={14} /> +91 93800 00001</a>
              <a href="tel:+919942333333" className="text-white/65 hover:text-[#C9A800] flex items-center gap-1.5 transition-colors"><Phone size={14} /> +91 99423 33333</a>
              <a href="mailto:mekalatransports@gmail.com" className="text-white/65 hover:text-[#C9A800] flex items-center gap-1.5 transition-colors"><Mail size={14} /> mekalatransports@gmail.com</a>
            </div>
          </motion.div>
          ...
          >
            {done ? (
              ...
              <form onSubmit={submit} className="border border-white/[0.06] rounded-lg p-5 space-y-2.5">
                ...
                <button type="submit" className="w-full flex items-center justify-center gap-1.5 bg-[#C9A800] text-black font-semibold py-2.5 rounded text-[14px] hover:bg-[#d4b320] transition-colors">
